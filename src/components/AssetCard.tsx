...
export function AssetCard({ ticker, name, price, change, changeValue, trendData }: AssetCardProps) {
  ...
  const getAssetImage = (ticker: string) => {
    ...
    const imageMap: Record<string, string> = {
      ...
      'himson': '/asset/acnon.png', // Using acnon as fallback for HIMS
  ...
  return (
    <div className={cn("rounded-2xl p-6 border border-gray-100 shadow-sm flex flex-col justify-between h-64 transition-all hover:shadow-md", bgColor)}>
